...
import (
	...
	"github.com/anhoangcao/go-fiber-postgres/models"
	"github.com/anhoangcao/go-fiber-postgres/storage"
...
func (r *Repository) UpdateBook(context *fiber.Ctx) error {
	...
	// Lấy thông tin của sách từ cơ sở dữ liệu theo ID
	...
	// Lấy dữ liệu từ request body và cập nhật vào updatedBook
	...
	// Cập nhật các trường của bookModel dựa trên dữ liệu mới
	...
	if updatedBook.Publisher != nil {
		bookModel.Publisher = updatedBook.Publisher
	}
